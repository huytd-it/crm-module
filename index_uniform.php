    ...
    <div class="inner">
      <ul class="no-bullets menuTab" id=ulList_2>
        <li class="active" id="li_online">
          <a href="#" class=lang vi="Kê khai hàng ngày(tại trường)" onclick="_loadPageContentURL('pages/internal/quan_li_file/View/uniform/admin.php');">
            Đồng phục
          </a>
        </li>
        <li id="li_hoc_bong">
...
<script type="text/javascript">
  setupMenuTab();
  _loadPageContentURL('pages/internal/quan_li_file/View/uniform/admin.php');
</script>